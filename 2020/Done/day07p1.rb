...
input = ['muted lavender bags contain 5 dull brown bags, 4 pale maroon bags, 2 drab orange bags.',
         ...
         'pale indigo bags contain 3 dark white bags.', 'plaid indigo bags contain 4 mirrored teal bags.',
         ...
         'dark teal bags contain 3 striped fuchsia bags.', 'plaid white bags contain 4 shiny salmon bags.',
         ...
         'plaid teal bags contain 3 mirrored bronze bags.', 'pale chartreuse bags contain no other bags.',
         ...
         'dim silver bags contain 4 plaid black bags.', 'faded violet bags contain 5 dark maroon bags.',
         ...
         'mirrored lavender bags contain 2 dim black bags.', 'shiny maroon bags contain 2 dotted beige bags.',
         ...
         'pale plum bags contain 5 clear plum bags.', 'vibrant silver bags contain 1 dim lavender bag, 4 bright teal bags.',
         ...
         'shiny fuchsia bags contain 3 dull black bags, 5 wavy coral bags.', 'dim gray bags contain 3 drab gray bags.',
         ...
         'plaid violet bags contain 2 dim coral bags.', 'striped chartreuse bags contain 2 shiny gray bags.',
         ...
         'muted beige bags contain 1 bright gray bag, 1 dark red bag.', 'shiny yellow bags contain 2 light plum bags.',
         'wavy indigo bags contain 1 faded red bag, 1 plaid yellow bag, 2 dull aqua bags.',
         'plaid maroon bags contain 5 vibrant beige bags.', 'wavy tan bags contain 5 plaid maroon bags.',
         ...
         'shiny magenta bags contain 5 light turquoise bags, 4 striped olive bags.', 'faded olive bags contain 2 clear white bags.',
         'pale aqua bags contain 2 vibrant fuchsia bags.', 'vibrant yellow bags contain 4 muted teal bags, 1 mirrored teal bag.',
         ...
         'posh black bags contain 3 pale tan bags, 1 dim brown bag, 5 clear green bags.', 'bright beige bags contain 4 dotted black bags.',
         ...
         'faded purple bags contain 4 faded indigo bags.', 'light beige bags contain 1 posh gray bag, 3 dotted white bags, 1 striped silver bag.',
         'vibrant magenta bags contain 4 drab red bags, 1 dotted white bag, 5 striped aqua bags.', 'light maroon bags contain 1 dull black bag.',
         'light olive bags contain 3 dull tan bags.', 'vibrant lime bags contain 2 dim lavender bags.',
         'muted aqua bags contain 3 bright olive bags, 1 muted teal bag, 3 dull crimson bags.', 'dotted beige bags contain no other bags.',
         ...
         'posh gold bags contain 5 faded lavender bags.', 'striped lime bags contain 4 striped coral bags.',
         ...
         'posh purple bags contain 4 dull cyan bags.', 'plaid blue bags contain 2 muted fuchsia bags, 1 bright teal bag, 2 pale chartreuse bags.',
         'dim lime bags contain 4 drab gold bags, 1 muted fuchsia bag, 1 posh tomato bag.', 'dark white bags contain 2 wavy gold bags.',
         'bright red bags contain 4 light fuchsia bags, 1 plaid orange bag, 1 pale red bag.',
         'wavy blue bags contain 4 striped red bags, 1 mirrored black bag.', 'light teal bags contain 1 faded orange bag, 5 muted white bags.',
         ...
         'pale turquoise bags contain 3 clear yellow bags, 2 dim coral bags.', 'vibrant plum bags contain 3 dotted yellow bags.',
         'drab cyan bags contain 5 vibrant green bags.', 'wavy crimson bags contain 1 mirrored gray bag, 2 dim teal bags.',
         'wavy maroon bags contain 3 pale tan bags.', 'light orange bags contain 4 vibrant silver bags, 2 dim olive bags, 2 drab red bags.',
         'plaid brown bags contain 2 bright turquoise bags, 4 shiny tan bags, 2 dull indigo bags, 3 plaid olive bags.',
         'posh silver bags contain 5 wavy coral bags.', 'wavy bronze bags contain 1 plaid yellow bag, 1 dim gold bag.',
         ...
         'dim salmon bags contain 3 dim brown bags, 5 drab chartreuse bags.', 'faded beige bags contain no other bags.',
         'dotted gray bags contain 5 dark lime bags, 2 posh black bags, 3 muted fuchsia bags.',
         'dull crimson bags contain 5 vibrant fuchsia bags.', 'drab brown bags contain 5 pale maroon bags, 5 light crimson bags.',
         'bright blue bags contain 5 vibrant brown bags.', 'bright violet bags contain 1 light white bag, 5 clear beige bags, 2 dull crimson bags.',
         ...
         'posh crimson bags contain 5 drab tan bags.', 'clear fuchsia bags contain 4 faded tomato bags, 1 dotted beige bag.',
         'bright maroon bags contain 2 wavy teal bags, 2 shiny gray bags, 5 dull gray bags, 3 dull teal bags.',
         'drab gray bags contain 3 dark white bags, 2 pale salmon bags, 4 bright teal bags.', 'vibrant brown bags contain 4 wavy salmon bags.',
         ...
         'wavy fuchsia bags contain 4 dotted olive bags, 1 dull brown bag.', 'mirrored olive bags contain 4 muted fuchsia bags, 4 striped turquoise bags.',
         'shiny salmon bags contain 2 dark white bags.', 'striped tan bags contain 4 mirrored purple bags.',
         'dull coral bags contain 3 posh coral bags, 1 dotted green bag.', 'drab teal bags contain 4 wavy yellow bags, 5 mirrored aqua bags.',
         'shiny tan bags contain 5 striped maroon bags, 5 vibrant red bags.', 'bright crimson bags contain 1 muted magenta bag.',
         ...
         'dotted brown bags contain 1 vibrant indigo bag, 1 plaid olive bag.', 'faded coral bags contain 5 muted bronze bags, 3 mirrored lavender bags.',
         ...
         'posh plum bags contain 1 shiny white bag, 1 striped lavender bag.', 'vibrant purple bags contain 5 bright teal bags.',
         'dark salmon bags contain 4 striped olive bags, 5 mirrored crimson bags, 5 plaid lime bags, 3 dark tomato bags.',
         'shiny silver bags contain 2 vibrant red bags.', 'dull turquoise bags contain 3 faded crimson bags, 1 drab maroon bag, 5 drab gold bags.',
         ...
         'bright teal bags contain 4 dim fuchsia bags.', 'clear turquoise bags contain 1 faded teal bag, 2 dull teal bags.',
         'wavy magenta bags contain 4 dim teal bags, 3 mirrored bronze bags, 3 plaid plum bags, 5 wavy lavender bags.',
         'faded bronze bags contain 2 striped salmon bags, 3 dark red bags, 1 dark indigo bag.', 'faded plum bags contain 1 clear green bag.',
         ...
         'plaid crimson bags contain 3 mirrored olive bags.', 'clear tan bags contain 1 vibrant purple bag, 1 wavy aqua bag.',
         ...
         'posh violet bags contain 1 muted fuchsia bag, 3 dim coral bags, 2 drab orange bags.', 'plaid cyan bags contain 2 shiny indigo bags.',
         ...
         'dim red bags contain 4 pale orange bags, 3 drab chartreuse bags.', 'vibrant turquoise bags contain 3 clear tomato bags, 4 posh blue bags.',
         ...
         'pale tomato bags contain 2 striped silver bags, 1 mirrored aqua bag.', 'pale salmon bags contain 4 muted indigo bags, 4 faded teal bags.',
         ...
         'bright gold bags contain 4 drab lavender bags.', 'dull white bags contain 4 clear salmon bags, 2 shiny gold bags.',
         'drab olive bags contain 3 pale lime bags, 3 striped crimson bags, 5 plaid gray bags, 2 posh magenta bags.',
         'bright cyan bags contain 4 dotted black bags.', 'drab beige bags contain 4 shiny yellow bags.',
         ...
         'plaid plum bags contain 5 pale violet bags, 3 posh yellow bags, 3 faded silver bags.', 'bright fuchsia bags contain 5 clear black bags.',
         'dotted red bags contain 3 dark magenta bags, 5 clear indigo bags, 1 faded bronze bag, 4 dotted gray bags.',
         'plaid turquoise bags contain 2 dark indigo bags.', 'pale lavender bags contain 4 posh fuchsia bags, 1 clear black bag, 4 wavy lime bags.',
         'bright lavender bags contain 2 wavy magenta bags, 5 plaid blue bags, 1 drab yellow bag, 1 muted gray bag.',
         'bright white bags contain 4 light gray bags.', 'dull black bags contain 2 shiny lime bags, 3 muted indigo bags, 5 faded beige bags.',
         'muted tomato bags contain 2 dark yellow bags.', 'plaid fuchsia bags contain 2 dull lavender bags.',
         'dark indigo bags contain 2 dim lavender bags, 3 shiny maroon bags.', 'mirrored magenta bags contain 1 mirrored chartreuse bag.',
         ...
         'striped turquoise bags contain 1 bright turquoise bag, 2 faded beige bags.', 'faded indigo bags contain 2 dotted purple bags.',
         ...
         'clear tomato bags contain 3 striped indigo bags, 3 dim fuchsia bags, 2 wavy gray bags.', 'faded teal bags contain no other bags.',
         ...
         'dotted white bags contain 4 dim olive bags.', 'dotted chartreuse bags contain 4 striped turquoise bags, 1 dotted silver bag.',
         ...
         'pale yellow bags contain 4 mirrored bronze bags.', 'light violet bags contain 5 dull black bags.',
         'posh green bags contain 1 plaid plum bag, 3 pale violet bags, 5 muted salmon bags.',
         'mirrored purple bags contain 3 mirrored aqua bags, 1 plaid blue bag.', 'clear orange bags contain 3 light beige bags.',
         'striped tomato bags contain 4 dark orange bags, 1 bright aqua bag.', 'dark gray bags contain 1 posh violet bag.',
         'plaid beige bags contain 5 pale beige bags.', 'plaid gray bags contain 3 mirrored bronze bags, 3 clear green bags, 5 dark chartreuse bags.',
         ...
         'muted orange bags contain 3 muted lavender bags.', 'muted crimson bags contain 4 muted cyan bags, 1 dull plum bag.',
         ...
         'dim brown bags contain no other bags.', 'muted chartreuse bags contain 2 dark coral bags, 5 striped plum bags.',
         ...
         'bright yellow bags contain 3 clear tomato bags.', 'clear bronze bags contain 4 wavy salmon bags.',
         ...
         'dull tan bags contain 5 dim red bags, 5 posh gold bags, 2 clear red bags.', 'mirrored plum bags contain 4 dim beige bags.',
         'wavy purple bags contain 2 posh silver bags, 5 shiny tan bags, 3 pale red bags, 3 dull salmon bags.',
         'dim black bags contain 3 light yellow bags.', 'dotted coral bags contain 3 pale violet bags.',
         'posh bronze bags contain 1 posh tomato bag, 1 drab purple bag, 3 dim fuchsia bags, 2 bright brown bags.',
         'wavy salmon bags contain no other bags.', 'dull blue bags contain 5 dark plum bags, 4 light yellow bags.',
         ...
         'mirrored chartreuse bags contain 5 muted olive bags.', 'dark lime bags contain 1 dark magenta bag.',
         'light coral bags contain 2 dull lavender bags.', 'bright lime bags contain 2 wavy bronze bags.',
         ...
         'posh orange bags contain 2 dark lime bags, 3 wavy purple bags.', 'posh magenta bags contain 2 dark teal bags.',
         'drab salmon bags contain 5 drab tomato bags.', 'muted fuchsia bags contain no other bags.',
         'wavy tomato bags contain 4 wavy black bags, 4 faded teal bags.', 'dim chartreuse bags contain 5 drab green bags, 4 drab magenta bags.',
         ...
         'dull green bags contain 5 muted tan bags, 5 drab red bags.', 'clear maroon bags contain 3 faded brown bags.',
         ...
         'plaid purple bags contain 3 drab yellow bags.', 'light plum bags contain 1 dotted aqua bag, 2 dark white bags.',
         ...
         'dull gold bags contain 4 muted salmon bags.', 'wavy olive bags contain 3 mirrored brown bags, 5 clear indigo bags.',
         ...
         'pale teal bags contain 3 dark violet bags, 5 shiny salmon bags.', 'plaid orange bags contain 5 faded green bags, 5 pale magenta bags.',
         'shiny crimson bags contain 5 shiny green bags, 1 bright tomato bag, 3 vibrant lime bags, 3 clear purple bags.',
         'muted indigo bags contain 4 dim brown bags, 1 dotted beige bag.', 'dark cyan bags contain 2 striped yellow bags.',
         ...
         'dull yellow bags contain 5 mirrored beige bags.', 'dotted maroon bags contain 3 clear salmon bags, 1 light salmon bag.',
         ...
         'striped magenta bags contain 2 dotted plum bags.', 'posh beige bags contain 5 vibrant maroon bags, 1 dim lavender bag.',
         ...
         'light tan bags contain 3 dotted red bags, 1 dark red bag.', 'pale green bags contain 4 dull salmon bags, 4 dim brown bags.',
         ...
         'dim violet bags contain 2 clear tan bags, 5 pale magenta bags.', 'dotted black bags contain 4 dark magenta bags.',
         ...
         'plaid black bags contain 3 posh brown bags, 3 dark maroon bags, 1 mirrored black bag.', 'dim olive bags contain 5 posh indigo bags.',
         ...
         'light green bags contain 1 drab red bag.', 'wavy plum bags contain 2 wavy gold bags, 5 bright tan bags.',
         'vibrant tan bags contain 3 drab gray bags.', 'shiny orange bags contain 2 clear plum bags, 1 posh red bag.',
         'dull lime bags contain 3 pale silver bags.', 'shiny cyan bags contain 3 shiny purple bags.',
         ...
         'clear gold bags contain 2 vibrant plum bags.', 'dark silver bags contain 4 striped gold bags, 4 plaid teal bags, 1 pale yellow bag.',
         ...
         'muted purple bags contain 3 dark maroon bags.', 'bright salmon bags contain 3 clear beige bags.',
         'mirrored lime bags contain 1 wavy coral bag, 1 mirrored gray bag.', 'faded cyan bags contain 2 pale bronze bags, 3 vibrant plum bags.',
         'dull aqua bags contain 2 dark coral bags, 3 clear turquoise bags.', 'posh aqua bags contain 1 pale teal bag, 2 dim coral bags.',
         ...
         'wavy yellow bags contain 4 pale fuchsia bags.', 'muted black bags contain 1 striped salmon bag, 1 shiny gold bag, 3 plaid gray bags.',
         ...
         'vibrant teal bags contain 1 dark teal bag, 4 dotted chartreuse bags.', 'bright plum bags contain 1 vibrant silver bag.',
         'dotted purple bags contain 3 faded beige bags, 3 muted lavender bags.',
         'faded tomato bags contain 1 muted olive bag, 5 faded orange bags, 5 light yellow bags.', 'light crimson bags contain no other bags.',
         ...
         'dim gold bags contain 4 dotted purple bags, 3 plaid blue bags.', 'dim crimson bags contain 5 muted magenta bags.',
         'shiny teal bags contain 1 dotted bronze bag, 4 vibrant teal bags, 4 pale blue bags.', 'drab blue bags contain 3 dark salmon bags.',
         'bright olive bags contain 5 pale fuchsia bags.', 'mirrored gold bags contain 2 posh brown bags, 2 bright purple bags, 5 shiny cyan bags.',
         'dim turquoise bags contain 4 pale cyan bags, 2 mirrored violet bags.',
         'clear silver bags contain 4 dark plum bags, 4 pale gray bags, 5 mirrored bronze bags.', 'clear olive bags contain 4 muted green bags.',
         'drab lime bags contain 3 dotted aqua bags, 2 faded blue bags, 3 faded salmon bags, 3 dim yellow bags.',
         'dim fuchsia bags contain no other bags.', 'mirrored black bags contain 1 dark white bag.',
         'clear cyan bags contain 3 plaid chartreuse bags, 3 plaid teal bags, 5 dark gold bags, 5 dim lime bags.',
         'bright tomato bags contain 4 dark green bags.', 'dim white bags contain 2 shiny yellow bags, 1 pale maroon bag.',
         ...
         'shiny plum bags contain 3 pale purple bags, 3 dim beige bags.', 'dark olive bags contain 4 dull coral bags.',
         ...
         'wavy violet bags contain 4 mirrored tomato bags, 4 striped gold bags.', 'plaid olive bags contain 3 dotted silver bags.',
         'light purple bags contain 2 dark red bags, 5 dull cyan bags, 4 plaid black bags.',
         'wavy orange bags contain 1 dim green bag, 4 dark coral bags.', 'vibrant red bags contain 4 posh brown bags.',
         ...
         'bright tan bags contain 1 posh black bag, 5 striped orange bags, 5 drab gold bags.', 'drab red bags contain 5 posh gray bags.',
         ...
         'muted yellow bags contain 2 clear red bags, 3 pale plum bags.', 'posh salmon bags contain 3 pale tan bags, 3 wavy gold bags.',
         ...
         'bright purple bags contain 4 wavy salmon bags, 1 dark teal bag, 4 pale yellow bags.', 'drab aqua bags contain 1 vibrant red bag.',
         ...
         'posh tan bags contain 3 dotted lime bags.', 'drab maroon bags contain 5 mirrored chartreuse bags.',
         'dim magenta bags contain 1 pale fuchsia bag, 2 light fuchsia bags, 5 bright bronze bags, 1 faded gray bag.',
         'shiny purple bags contain 2 pale chartreuse bags.', 'drab turquoise bags contain 4 light turquoise bags.',
         ...
         'dotted cyan bags contain 2 faded plum bags.', 'dim orange bags contain 5 light brown bags, 5 bright yellow bags.',
         ...
         'dull lavender bags contain 5 muted gold bags, 5 pale maroon bags.', 'light black bags contain 1 dark plum bag, 1 shiny gold bag.',
         ...
         'clear beige bags contain 4 striped salmon bags.', 'light lavender bags contain 1 wavy silver bag, 1 dark indigo bag.',
         'posh red bags contain 4 muted olive bags, 3 light tan bags, 4 clear gray bags, 2 dim lime bags.',
         'clear coral bags contain 3 light lime bags, 2 posh violet bags.', 'plaid salmon bags contain 2 pale yellow bags, 5 dark plum bags.',
         ...
         'vibrant gold bags contain 1 shiny fuchsia bag.', 'dark black bags contain 2 wavy lime bags, 1 pale cyan bag, 4 posh brown bags.',
         ...
         'mirrored turquoise bags contain 2 muted teal bags.', 'drab purple bags contain 5 dotted plum bags, 1 plaid plum bag.',
         'dotted tan bags contain 1 pale plum bag, 1 dotted aqua bag.', 'drab bronze bags contain 4 vibrant red bags, 4 light blue bags.',
         ...
         'dotted plum bags contain 5 mirrored green bags, 1 dark plum bag, 4 dark maroon bags.', 'faded gold bags contain 4 pale yellow bags.',
