...
while true
    ...
    while i < height
        ...
        j = 0
        while j < width
            if @input[i][j] == 'L' && count_occupied(i, j).nil?
                new_row << '#'
