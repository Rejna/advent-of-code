...
# Solution to Advent of Code 2019 Day 17 Part 1
...
def check_neighbours(x, y)
  if @new_area[y - 1][x] == '#' && @new_area[y + 1][x] == '#' && @new_area[y][x - 1] == '#' &&
     @new_area[y][x + 1] == '#' && @new_area[y][x] == '#'
    @new_area[y][x] = 'O'
    @alignment += x * y
  end
end
...
@memory = [1, 330, 331, 332, 109, 3376, 1101, 1182, 0, 16, 1102, 1, 1449, 24, 101, 0, 0, 570, 1006, 570, 36, 1001, 571,
...
i = 1
while i < @new_area.length - 1
  j = 1
  while j < @new_area[i].length - 1
