...
# Solution to Advent of Code 2017 Day 20 Part 2
# https://adventofcode.com/2017/day/20#part2
# Answer is: 657

input = File.readlines('../1_Input/day20.input')
# input = File.readlines('../1_Input/day20test2.input')
...
50.times.each do
  ...
  tally = particles.map(&:first).tally

  next unless tally.values.any? { |v| v > 1 }

  crashes = tally.select { |_k, v| v > 1 }
  crashes.each do |cr|
    particles.delete_if { |p| p[POSITION] == cr[0] }
  end
end
