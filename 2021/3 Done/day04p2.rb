...
# Solution to Advent of Code 2021 Day 4 Part 2
      ...
      while k < board_size
        if @boards[i][j][k] == number
          ...
          if bingo != 0
            ...
            # pp @marked
            # puts '----------'
            if @boards_with_bingoes.tally[false] == 1
              done = true
            else
              @boards_with_bingoes[i] = true
              board_done = true
            end
          end
        end
