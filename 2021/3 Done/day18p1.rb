...
# inputs = File.readlines('../1 Input/day18test.input').map(&:strip)
# inputs = File.readlines('../1 Input/day18homework.input').map(&:strip)
inputs = File.readlines('../1 Input/day18.input').map(&:strip)
