...
# inputs = File.readlines('../1 Input/day22smalltest.input').map(&:strip)
# inputs = File.readlines('../1 Input/day22largetest.input').map(&:strip)
inputs = File.readlines('../1 Input/day22.input').map(&:strip)
